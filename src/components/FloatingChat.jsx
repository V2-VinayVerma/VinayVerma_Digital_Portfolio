...
export default function FloatingChat() {
  return (
    <div className="fixed bottom-6 right-6 z-[9990] flex flex-col items-end gap-4">
      {/* Primary Floating Action Button (FAB) - WhatsApp Only */}
      <a 
        href="https://wa.me/917988331441?text=Hi%20Vinay!%20I%20saw%20your%20portfolio%20and%20would%20love%20to%20connect."
        target="_blank"
        rel="noopener noreferrer"
        className="relative w-14 h-14 bg-[#25D366] hover:bg-[#1DA851] shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.5)] rounded-full flex items-center justify-center text-white transition-all transform hover:scale-110 z-[10000]" 
